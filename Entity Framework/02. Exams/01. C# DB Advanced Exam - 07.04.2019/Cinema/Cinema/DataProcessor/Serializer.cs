    ...
    public class Serializer
    {
        public static string ExportTopMovies(CinemaContext context, int rating)
        {
            var movies = context.Movies
                ...
                .Select(m => new ExportMovieInRatingRangeDto
                {
                    MovieName = m.Title,
                    ...
                    .SelectMany(p => p.Tickets)
                    .Select(t => new ExportCustomerInRatingRangeDto
                    {
        ...
        public static string ExportTopCustomers(CinemaContext context, int age)
        {
            var customers = context.Customers
                ...
                .Select(c => new ExportCustomerInAgeRangeDto
                {
            ...
            var xmlSerializer = new XmlSerializer(typeof(ExportCustomerInAgeRangeDto[]), new XmlRootAttribute("Customers"));
